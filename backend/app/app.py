...
from functions.db_functions import get_userID, get_user_last_research_date, get_user_providers, modify_user_providers, get_user_results, modify_last_research_user, modify_film
from functions.fetch_functions import get_ids, get_providers, get_watchlist, get_all_regions, region_providers, sort_watchlist
...
def get_home():
    return "Boum boum, server is running !"
...
@app.route('/region_providers', methods=['GET'])
def get_region_providers():
    ...
    return {"country_code" : country_code, "providers": region_providers(country_code)}
